...
resource "aws_lambda_function" "my_lambda_function" {
    ...
    environment {
        variables = {
            "BUCKET_PATH" = "source-bucket-mamadou-01/incoming/"
        }
    }
}
    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:s3:::source-bucket-mamadou-01/*"
        },
        {
            "Effect": "Allow",
            "Action": [
...
resource "aws_s3_bucket_notification" "lambda_trigger" {
    bucket = "source-bucket-mamadou-01"
...
resource "aws_lambda_permission" "allow_s3_to_invoke_lambda" {
  ...
  source_arn    = "arn:aws:s3:::source-bucket-mamadou-01"
}
